            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="flex justify-end pt-1">
                            <Link 
                                to="/forgot-password"
                                className="text-sm font-medium text-blue-600 relative group overflow-hidden pb-0.5"
                            >
                                <span className="relative z-10 transition-colors group-hover:text-blue-700">Lupa Password?</span>
                ...
                <div className="relative my-6">
                    ...
                    <div className="relative flex justify-center text-sm">
                        <span className="px-4 text-gray-400 bg-white font-medium text-xs uppercase tracking-wider">ATAU MASUK DENGAN</span>
                    </div>
                </div>
                ...
                <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    onClick={googleLogin}
                    className="w-full flex items-center justify-center px-4 py-3 border border-gray-200 rounded-xl shadow-sm text-sm font-semibold text-gray-700 bg-white transition-all hover:bg-gray-50 hover:border-blue-200 hover:text-blue-700 hover:shadow-md"
                >
