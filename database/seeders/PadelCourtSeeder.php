...
class PadelCourtSeeder extends Seeder
{
    ...
    {
        $names = [
            'Padel Arena', 'Surabaya Padel Club', 'Smash Padel', 'Elite Padel', 
            'Pro Padel Surabaya', 'Central Padel', 'West Side Padel', 'East Coast Padel',
            'Victory Padel', 'Champion Padel', 'Star Padel', 'Royal Padel'
        ];
        $days = ["Senin", "Selasa", "Rabu", "Kamis", "Jumat", "Sabtu", "Minggu"];
        $facilities_list = ["WiFi", "Parkir Mobil", "Toilet", "Locker Room", "Kantin", "Sewa Raket", "Sewa Bola"];

        for ($i = 1; $i <= 50; $i++) {
            $randomName = $names[array_rand($names)] . " " . $i;
